          ...
          {filtered
            ...
            .map((p) => {
              ...
              return (
                <div
                  key={p.id}
                  className="bg-white border border-slate-200/40 rounded-2xl overflow-hidden shadow-sm group relative cursor-pointer"
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    {p.caption && <p className="text-[11px] text-slate-600 line-clamp-2">{p.caption}</p>}
                  </div>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
